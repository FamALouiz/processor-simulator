...
The project includes comprehensive unit and functional tests. To run all tests:
...
Alternatively, you can manually build and run individual tests:
...
The tests are automatically run on GitHub through workflows when pushing to the main/master branch or creating pull requests.
